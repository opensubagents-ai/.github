...
| **GCP** (Google Cloud Platform) | Compute, GCS, AlloyDB Omni (self-hosted image), Vertex AI, **Gmail (via operator's account)**, **Google Calendar** | Primary "third hyperscaler"; covers Gmail + Calendar via the operator's Google identity |
...
| **Slack** (workspace messaging) | meta (cross-cut) | **0012** | **Proposed** (connector available 2026-05-24; opt-in pending) |
